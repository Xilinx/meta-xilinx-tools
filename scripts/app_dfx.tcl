...
set option {
	...
	{rphdf.arg	""			"hardware Definition file"}
	{hdf_type.arg 	""			"hardware Definition file"}
...
if { $params(ws) ne "" } {
	...
	if { $params(pname) ne "" } {
		...
		platform create -name $params(hwpname) -hw $params(hdf) -rm-hw $params(rphdf) -os device_tree -proc $params(processor) -out $params(ws)
		...
		#domain create -name $params(bspname) -proc $processor \
				  -os $params(osname) -arch $params(arch)
