...
set_hw_design $project $params(hdf) $params(rphdf) $params(hdf_type)
...
if {[catch {hsi create_sw_design \
		-os device_tree -proc $processor sd22} res] } {
